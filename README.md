...
|**Save and Auto Save**|Code and editor settings get auto-saved after every 10 seconds to prevent lose of code on closing the window accidently. User can also save the code manually by clicking the save button.|
